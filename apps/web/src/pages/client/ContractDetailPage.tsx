...
export const ContractDetailPage: React.FC<ContractDetailPageProps> = ({ id }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      {/* Back stays outside the overlay — a dead end here would trap someone
          who followed a link into a contract they can no longer act on. */}
      <button
        onClick={goBack}
      ...
      <ComingSoonOverlay description="A dedicated contract workspace — including a real invoice, reviews and dispute handling from this screen — is coming soon.">
          ...
          <Card className="p-8 space-y-5">
            ...
            {isClient && c.status === 'ACTIVE' && !eventHasPassed && (
              <p className="text-[11px] text-ink-muted">
                You can confirm completion once the event date has passed. It also completes on its
                own a few days after the event if you don't.
              </p>
            )}
          </Card>
            ...
            <Card className="p-8 space-y-4">
              <div>
                ...
                <p className="text-[11px] text-ink-muted mt-0.5">
                  Stays hidden on their public profile until {otherParty.displayName} reviews you
                  back, or 14 days pass.
                </p>
              </div>
              ...
              {myReview.loading ? (
                ...
                <div
                  className="space-y-2"
                  data-testid="my-review"
                  data-rating={myReview.data.rating}
                >
              ...
              >
                <div className="flex items-start justify-between gap-3 flex-wrap">
                  ...
                  <span className="text-[11px] text-red-800 dark:text-red-300">
                    Raised by{' '}
                    {activeDispute.raisedByUserId === currentUser.id
                      ? 'you'
            ...
            <div className="space-y-6 pt-2 text-xs">
              <div className="print-area p-8 bg-white text-ink border border-border rounded-2xl shadow-xs space-y-6">
                ...
                <p className="text-[10px] text-ink-muted italic leading-relaxed pt-4 border-t border-border">
                  ...
                  booking. It does not replace a formal tax invoice; Marché does not currently issue
                  or process payments for this booking.
                </p>
              </div>
