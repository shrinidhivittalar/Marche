...
export const INITIAL_TALENT: TalentProfile[] = [
  {
    ...
    category: 'Photography',
    headline: 'Master Editorial & Event Photographer • Vance Visuals Studio',
...
export const INITIAL_WORK_HISTORY: ProviderWorkHistoryEntry[] = [
  {
    ...
    amount: 3800,
    rating: 5.0,
    review: 'Julian captured every key moment of our launch flawlessly — gallery delivered same day.',
  ...
  },
  {
    ...
    amount: 6400,
    rating: 5.0,
    review: 'Ava managed every vendor flawlessly — zero stress on our end.',
...
export const INITIAL_TESTIMONIALS: ProviderTestimonial[] = [
  {
    ...
    vendorId: 'user_vendor_1',
    quote:
      'Julian captured our entire product launch with incredible precision — every hero shot was ready for press within hours. His communication throughout was outstanding.',
  ...
  },
  {
    ...
    vendorId: 'user_vendor_1',
    quote:
      'What stands out about Julian is how proactively he plans the shot list before the event — nothing is ever missed on the day.',
...
export const INITIAL_NOTIFICATIONS: Notification[] = [
  {
    ...
    message: 'Julian Vance submitted a proposal ($3,800) for your E-Commerce Platform Redesign job.',
    type: 'proposal',
    read: false,
    timestamp: '2026-07-21T11:40:00Z',
  ...
  },
  {
    ...
    message: 'Clara Dupont Studio submitted a proposal ($4,200) for your E-Commerce Platform Redesign job.',
    type: 'proposal',
    read: true,
