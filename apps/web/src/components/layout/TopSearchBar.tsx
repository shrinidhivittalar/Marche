...
export const TopSearchBar: React.FC = () => {
  ...
  return (
    <button
      ...
      className="hidden md:flex items-center gap-2 bg-[#1a1512] hover:bg-[#241d18] text-white rounded-full px-5 py-2.5 shadow-md transition-colors cursor-pointer text-sm font-semibold"
    >
