      ...
      <div className="flex-1 flex flex-col p-3 sm:p-4 overflow-y-auto">
        ...
        <div className="flex-1 flex items-center justify-center py-6">
          <div className="auth-card opacity-0 w-full max-w-md bg-white border border-border rounded-2xl p-5 sm:p-6 shadow-marche-card shadow-2xl space-y-4">
            ...
            <div className={`grid ${GOOGLE_CLIENT_ID ? 'grid-cols-2' : 'grid-cols-1'} gap-2.5`}>
              {GOOGLE_CLIENT_ID && (
                <button
                  type="button"
                  onClick={handleGoogleSignIn}
                  disabled={isGoogleSubmitting}
                  className="flex items-center justify-center gap-2 px-3 py-2 bg-bg border border-border hover:bg-zinc-100 rounded-xl text-xs font-semibold text-ink transition-all cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                >
